...
<%-- 
    Document   : apartment.jsp
    Created on : Nov 26, 2018, 11:36:42 PM
    Author     : Abhinav
--%>
                                ...
                                <div class="row">
                                    <% 
                                        ...
                                        if(request.getParameter("price2") != null){
                                            price = "<="+request.getParameter("price2");
                                        }
                                        else{
                                             price = "is not null";
                                        }
                                        ...
                                        if(request.getParameter("washroom") != null){
                                            washroom = ">="+request.getParameter("washroom");
                                        }
                                        else{
                                             washroom = "is not null";
                                        }
                                        query = "select * from apartment where location "+location+" and price "+price+" and washroom "+washroom+" and bedrooms "+bedroom;
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <div class="apartments-content">
                                            <div class="image-content">
                                                <a href="apartment-single.jsp?name=<% out.println(rs.getString("name")); %>">
                                            ...
                                            <div class="text-content">
                                                <div class="top-content">
                                                    <h3>
                                                        <a href="apartment-single.jsp?name=<% out.println(rs.getString("name")); %>"><% out.println(rs.getString("name")); %>(<% out.println(rs.getString("availability")); %>)</a>
                                                    </h3>
                                                   <span>
                                                ...
                                                <div class="bottom-content clearfix">
                                                    <div class="meta-bed-room">
                                                        <i class="fa fa-bed"></i> <% out.println(rs.getInt("bedrooms")); %> Bedrooms
                                                    </div>
                                                    <div class="meta-bath-room">
                                                        <i class="fa fa-bath"></i><% out.println(rs.getInt("washroom")); %> Bathroom
                                                    </div>
